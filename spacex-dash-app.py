...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(success_counts, values='successes', 
                     names='Launch Site', 
        ...
        success_fail_counts['class'] = success_fail_counts['class'].map({0: 'Failure', 1: 'Success'})
        fig = px.pie(success_fail_counts, values='count', 
                     names='class', 
